...
user_item_rate_class_file = "user_item_rate_class/user_item_rate_class.txt"
        ...
        with open(rating_file) as trainData:
            ...
            for line in trainData:
                ...
                if '|' in line:
                    ...
                    cur_user = temp[0]
                    # print(cur_user)
                    user_item_rate_class.write(cur_user+"|"+temp[1]+"\n")
                # Read track ID lines
                else:
                    ...
                    if cur_item in classification:
                        ...
                        cur_item_class = 1
                    user_item_rate_class.write(cur_item+","+cur_item_rate+","+str(cur_item_class)+"\n")
