...
TRACK_HIERARCHY_FILE = "test_user_tracks_info.csv"
TEST_DATA_FILE = "../raw_data/testIdx2.txt"
	...
	with open(TEST_DATA_FILE) as testData:
		for line in testData:
			...
			# Track item have no "|" in the line
				...
				testHierarchy.write(cur_user+","+cur_track+","+lib_trackData[cur_track].replace("|", ",") +" \n")
			print(cur_user)
