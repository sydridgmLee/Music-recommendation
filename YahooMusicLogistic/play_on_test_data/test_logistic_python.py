...
def main():
    with open(factor_matrix, 'w') as result_data:
        with open(test_user_tracks_info_file) as test_user_tracks_info_data:
            with open(user_item_rate_class_file) as user_item_rate_class_data:
                with open(mean_hierarchy_file) as mean_data:
                    ...
                    lines_test = read_lines(test_user_tracks_info_data, 6)
                    train_user_id = -1
                    mean_user_id = -1
                    while lines_test:
                        ...
                        # print(mean_hierarchy_dic)

                        for line_test in lines_test:
                            test_user_tracks_info = line_test.strip("\n").split(",")

                            album_data_feature = []
                            artist_data_feature = []
                            genre_data_feature = []

                            if test_user_tracks_info[2] != "None":
                                album_id = int(test_user_tracks_info[2])
                            ...
                            if test_user_tracks_info[3] != "None":
                                artist_id = int(test_user_tracks_info[3])
                            ...
                            if len(test_user_tracks_info) > 4:
                                genre_list = test_user_tracks_info[4:]
